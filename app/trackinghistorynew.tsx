...
export default function SymptomCalendar() {
  ...
  const symptomIcons: Record<string, { label: string; icon: string; color: string }> = {
    debolezzaMuscolare: { label: "Debolezza muscolare", icon: "fitness", color: Colors.pink },
    affaticamentoMuscolare: { label: "Affaticamento muscolare", icon: "barbell", color: Colors.pink },
    ptosi: { label: "Ptosi", icon: "eye", color: Colors.pink },
    diplopia: { label: "Diplopia", icon: "eye-off", color: Colors.pink },
    difficoltaRespiratorie: { label: "Difficoltà respiratorie", icon: "cloudy-night", color: Colors.pink },
    ...
    andamentoSintomi: { label: "Andamento dei sintomi", icon: "pulse", color: Colors.pink },
  };
                  ...
                  return (
                    <View key={idx} style={styles.symptomRow}>
                      ...
                      <Text style={styles.symptomText}>
                        {meta.label}: {value === "true" ? "Sì" : value === "false" ? "No" : value}
                      </Text>
                    </View>
                  );
                })}
